...
/**
 * ContractifyProductionBuilder is used to configure and build an instance of the SDK.
 * 
 * @package Contractify\ContractifyAPI
 */
class ContractifyProductionBuilder
{
     ...
     * @return ContractifyProductionBuilder
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): ContractifyProductionBuilder
    {
     ...
     * @return ContractifyProductionBuilder
     */
    public function setSecurity(Models\Shared\Security $security): ContractifyProductionBuilder
    {
     ...
     * @return ContractifyProductionBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): ContractifyProductionBuilder
    {
     ...
     * @return ContractifyProductionBuilder
     */
    public function setServerIndex(int $serverIdx): ContractifyProductionBuilder
    {
     ...
     *
     * @return ContractifyProduction
     */
    public function build(): ContractifyProduction
    {
        ...
        return new ContractifyProduction($this->sdkConfig);
    }
}